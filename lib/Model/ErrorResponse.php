...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets tracking_id
     *
     * @param string $tracking_id Identifier used for tracking purposes.
     *
     * @return self
     */
     ...
     * Sets method
     *
     * @param string $method HTTP method of the API call which produced the error.
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string $path HTTP path of the API call which produced the error.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message Error message. Ideally human readable string.
     *
     * @return self
     */
