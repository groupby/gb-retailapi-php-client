...
class FulfillmentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('place_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Fulfillment type. Place where product fulfilled.
     *
     * @return self
     */
    ...
    {
        return $this->container['place_ids'];
    }

    /**
     * Sets place_ids
     *
     * @param string[]|null $place_ids Place ids where product fulfilled (array).
     *
     * @return self
     */
    public function setPlaceIds($place_ids)
    {
        if (is_null($place_ids)) {
            throw new \InvalidArgumentException('non-nullable place_ids cannot be null');
        }
        $this->container['place_ids'] = $place_ids;
