...
/**
 * SelectedRefinementDto Class Doc Comment
 *
 * @category Class
 ...
 */
class SelectedRefinementDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelectedRefinementDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['navigation_name'] === null) {
            $invalidProperties[] = "'navigation_name' can't be null";
        }
     ...
     *
     * @param string $navigation_name The name of the navigation the refinement is for.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param NavigationTypeDto $type type
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Value of selected refinement, if type is value.
     *
     * @return self
     */
     ...
     * Sets low
     *
     * @param float|null $low The lowest end or value of the range, if applicable.
     *
     * @return self
     */
     ...
     * Sets high
     *
     * @param float|null $high The highest end or value of the range, if applicable.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Field which is indicated that it is dynamic navigation.
     *
     * @return self
     */
     ...
     * Sets or
     *
     * @param bool|null $or Navigation multiselect. Indicate that it is possibly to select more than one navigation value due to search request.
     *
     * @return self
     */
