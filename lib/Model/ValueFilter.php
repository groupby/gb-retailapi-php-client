 ...
 */
class ValueFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValueFilter';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['number_value'] === null) {
            $invalidProperties[] = "'number_value' can't be null";
        }
     ...
     * Sets field
     *
     * @param string $field Field the value applies to.
     *
     * @return self
     */
     ...
     * Sets number_value
     *
     * @param float $number_value Numeric value to filter on.
     *
     * @return self
     */
     ...
     * Sets exclude
     *
     * @param bool $exclude Describing whether the filter is negated or not: color that is NOT red.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param mixed $type Determine which field we need to use - value if 'TEXTUAL' type or numberValue if 'NUMERIC' type.
     *
     * @return self
     */
